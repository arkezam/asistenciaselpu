          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
				...
				<form name="formulario1" action="<?php echo base_url();?>cpanel/ingresorem" method="POST">
					<button type="submit" class="btn btn-default btn-flat">Ingreso asistencia remota</button> 
